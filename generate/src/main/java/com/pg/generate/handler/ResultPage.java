package com.pg.generate.handler;

public class ResultPage<T> {
    private Integer code;
    private String msg;
    private com.pg.generate.handler.PageInfo<T> data;

    public ResultPage(BusinessStatus businessStatus, com.pg.generate.handler.PageInfo<T> pageInfo) {
